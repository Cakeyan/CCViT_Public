...
def get_args():
    parser = argparse.ArgumentParser('CCViT fine-tuning and evaluation script for image classification', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='ccvit_base_patch16_224', type=str, metavar='MODEL',
    ...
    parser.add_argument('--val_reconstructed', action='store_true')
...
def main(args, ds_init):
    ...
    if args.eval:
        ...
        # ii = 0
        # jj = 0
        # for i in range(41, 42, 2):
        #     for j in range(40, 41, 1):
        #         if i != 41 and j != 40:
        #             continue
        #         j = j/10
        #         print("####################")
        #         dataset_val, _ = build_dataset(is_train=False, args=args, i=i, j=j)
        #         data_loader_val = torch.utils.data.DataLoader(
        #             dataset_val, sampler=sampler_val,
        #             batch_size=int(1.5 * args.batch_size),
        #             num_workers=args.num_workers,
        ...
        #         if final1 <= test_stats['acc1']:

        #             final1 = test_stats['acc1']
        #             final2 = test_stats['acc5']
        #             ii = i
        #             jj = j
        #         print("####################")
        # print(f"Accuracy: acc1: {final1:.1f}%, acc5: {final2:.1f}%, kernel_size: {ii}, sigma: {jj}")
